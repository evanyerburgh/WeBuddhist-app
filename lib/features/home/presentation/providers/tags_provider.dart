...
// Tags provider - returns List<String>
// Watches localeProvider to refresh when language changes
final tagsFutureProvider = FutureProvider<List<String>>((ref) async {
  final locale = ref.watch(localeProvider);
  final useCase = ref.watch(getTagsUseCaseProvider);

  final result = await useCase(GetTagsParams(language: locale.languageCode));
